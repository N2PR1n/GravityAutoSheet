...
class AIBaseService:
    ...
    - shop_name: **กฎเหล็กเรื่อง LazMall**: 
      - ใน Lazada คำว่า "LazMall" คือเครื่องหมายรับรอง **ไม่ใช่ชื่อร้าน**
      - **ห้าม** ใส่คำว่า "LazMall", "Mall", "Official Store", "Flagship Store", "Thailand" มาในชื่อร้าน
      - **วิธีที่ถูกต้อง**: ถ้าเจอ "LazMall Oppo Official Store" ให้ตอบแค่ "Oppo"
    ...
    - receiver_name: **ชื่อผู้รับ** (บรรทัดแรกสุดของที่อยู่) 
      - **ห้ามสะกดผิดแม้แต่ตัวเดียว** เพ่งพินิจ ร/ว, ช/ซ, ต/ด ให้ดี (เช่น "ริชาล" ห้ามเป็น "วิชาล")
    ...
    - coins: **ยอดส่วนลดจากเหรียญ/พอยท์เท่านั้น**
      - **ตำแหน่ง**: มองหาในส่วน "สรุปข้อมูลคำสั่งซื้อ" (Order Summary) 
      - **ลักษณะ**: ต้องเป็นหน่วยเงินบาทที่ **ติดลบ** หรือระบุว่าเป็นส่วนลด (เช่น "เหรียญ -฿21.00", "ใช้ 2100 เหรียญ ลด ฿21.00")
      - **ข้อควรระวังพิเศษ**: บางบิลอาจจะมีส่วนลดหลายบรรทัดติดกัน (เช่น คูปอง Lazada, คูปองร้านค้า, เหรียญ) ให้ไล่อ่านทีละบรรทัดอย่างละเอียด ห้ามมองข้ามบรรทัด "เหรียญ" เด็ดขาด
      - **คำเตือนด่วน**: ห้ามเอา "คูปองส่วนลด", "ส่วนลดร้านค้า" หรือ "เหรียญที่จะได้รับ" (Earned Coins) มาใส่เด็ดขาด
      - **ถ้าไม่มีส่วนลดเหรียญ**: ให้ตอบ 0.00 ทันที
    ...
    - tracking_number: **เฉพาะ Amaze** (12 หลัก) ถ้าเจ้าอื่นให้ใส่ ""
