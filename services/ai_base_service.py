...
class AIBaseService:
    ...
    **⚠️ คำเตือนสำคัญมาก: ภาพที่ได้รับอาจเกิดจากการต่อรูป (Stitch) 2 ภาพเข้าด้วยกัน ซึ่งตำแหน่งซ้ายขวาอาจสลับกันได้ (บางครั้งรายละเอียดการสั่งซื้ออยู่ซ้าย บางครั้งอยู่ขวา) ดังนั้น ให้ AI กวาดสายตาอ่านข้อมูลให้ทั่วทั้งภาพ 100% ก่อนดึงข้อมูล ห้ามทึกทักเอาเองจากฝั่งใดฝั่งหนึ่ง**
    ...
    - tracking_number: **เลขพัสดุสำหรับจัดส่งสินค้า**
      - ให้มองหาคำที่มีความหมายว่าเลขพัสดุ เช่น **"หมายเลขพัสดุ"**, **"Tracking Number"**, หรือ **"เลขติดตามพัสดุ"** แล้วดึงเลขที่อยู่ใกล้เคียงมา
      - **ดึงของทุก Platform** (ไม่จำกัดเฉพาะ Amaze แล้ว) เจอที่ไหนในภาพให้ดึงมาให้ครบทุกตัวอักษรและตัวเลข
      - **กฎเหล็ก**: ห้ามเอา "หมายเลขคำสั่งซื้อ" หรือ "Order ID" มาใส่ในช่องนี้เด็ดขาด (Tracking Number มักจะมีตัวอักษรภาษาอังกฤษปนอยู่ด้วย หรือเป็นเลขยาวๆ ของบริษัทขนส่ง)
      - ถ้าในภาพแสดงแค่สถานะ "กำลังจัดส่ง" หรือ "รอจัดส่ง" แต่**ยังไม่ปรากฏเลขพัสดุ**เลย ให้ตอบ "" (ค่าว่าง) ห้ามเดาเลขเอง
