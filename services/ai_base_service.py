...
class AIBaseService:
    ...
    **⚠️ คำเตือนสำคัญมาก: ภาพที่ได้รับอาจเกิดจากการต่อรูป (Stitch) 2 ภาพเข้าด้วยกัน ซึ่งตำแหน่งซ้ายขวาอาจสลับกันได้ (บางครั้งรายละเอียดการสั่งซื้ออยู่ซ้าย บางครั้งอยู่ขวา) ดังนั้น ให้ AI กวาดสายตาอ่านข้อมูลให้ทั่วทั้งภาพ 100% ก่อนดึงข้อมูล ห้ามทึกทักเอาเองจากฝั่งใดฝั่งหนึ่ง**
    ...
    - coins: **ยอดส่วนลดจากเหรียญ/พอยท์ที่ถูกใช้เป็นส่วนลดเท่านั้น**
      - **เป้าหมายที่ต้องดึงมาใส่ใน coins**: บรรทัดที่เขียนว่า "เหรียญ", "ใช้ 2100 เหรียญ ลด ฿21.00" หรือบรรทัดที่เขียนว่า **"ใช้พอยท์แทนเงินสด"** 
      - **กฎเหล็ก**: ถ้าคุณมองเห็นคำว่า **"ใช้พอยท์แทนเงินสด"** ในใบเสร็จ (เช่น ใช้พอยท์แทนเงินสด - ฿1,104.00) จำนวนเงินตรงนั้น **คือ coins ทันที!!** ให้เอาตัวเลขนั้นมาตอบเป็น coins 
