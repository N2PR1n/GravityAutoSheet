...
class AIBaseService:
    ...
    - item_name: ตัดคำโฆณาในวงเล็บ [] หรือ () ด้านหน้าออก เอาเฉพาะชื่อสินค้าหลัก สั้นกระชับ ไม่เกิน 30 ตัวอักษร **และถ้ามีจำนวนมากกว่า 1 ให้ต่อท้ายด้วย "xจำนวน" (เช่น "AirPods4 x10")**
    ...
    - price: **ต้องเป็น "ยอดชำระจริง", "รวมยอดสั่งซื้อ" หรือ "ยอดโอน" (Net Payment / Grand Total) เท่านั้น**
      - **วิธีหา**: ให้หาบรรทัดที่เขียนว่า "รวมยอดสั่งซื้อ", "ยอดชำระเงิน", "Net Total" หรือยอดรวมสุทธิที่อยู่ด้านล่างสุดของบิล
      - **ห้ามเด็ดขาด**: ห้ามเอาราคาต่อชิ้น (Unit Price) ของสินค้ามาตอบ เช่น ราคาที่อยู่ติดกับชื่อสินค้า หรือราคาที่มีตัวคูณ (เช่น x2, x3) อยู่ข้างๆ
    ...
    - coins: ยอดส่วนลดที่เกิดจากการใช้เหรียญหรือพอยท์แทนเงินสด (เช่น "Shopee Coins", "ใช้พอยท์แทนเงินสด")
      ...
      - **ห้ามเด็ดขาด 2 (ระวังเป็นพิเศษ)**: ห้ามเอาตัวเลขจากบรรทัด **"อเมซพอยท์"** มาตอบเด็ดขาด ไม่ว่าจะเป็น "อเมซพอยท์ ที่จะได้รับ" หรือ **"อเมซพอยท์ พิเศษ"** (Amaze Points / Special Points) แม้จะเห็นตัวเลขเยอะๆ เช่น 700.00 หรือ 1,600 ก็ห้ามดึงมาใส่เด็ดขาด เพราะนั่นคือ "คะแนนสะสม" ไม่ใช่ "ส่วนลด" (เช่น "อเมซพอยท์ ที่จะได้รับ (≈16.47 บาท)" -> **ต้องตอบ coins: 0.00 เท่านั้น**)
    - date: รูปแบบ **"DD/MM"** เท่านั้น (ไม่ต้องใส่ปี)
      - **กฎลำดับความสำคัญ (สำคัญมาก)**:
        1. ให้มองหาคำว่า **"วันที่สั่งซื้อสินค้า"** หรือ **"วันที่สั่งซื้อ"** เป็นอันดับหนึ่ง (มักอยู่โซนล่างใกล้ๆ เลขออเดอร์)
        2. ถ้าไม่เจอค่อยไปมองหา "วันที่ชำระเงิน" หรือ "วันที่" ทั่วๆ ไป
      - **คำเตือนเรื่องปี**: ห้ามเอาเลขปี (เช่น 2026, 2568) มาสับสนเป็นเดือนเด็ดขาด (เช่น "25 ก.พ. 2026" ต้องตอบ "25/02" ห้ามตอบ "25/26" หรือ "25/4")
      - **ชื่อเดือน**: แปลง ก.พ. -> 02, มี.ค. -> 03 ให้ถูกต้องตามมาตรฐาน
