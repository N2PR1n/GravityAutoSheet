...
class OpenAIService:
    ...
    - platform: "Shopee", "Lazada", "TikTok", "Amaze", "LineMan", "Grab" (ตัวแรกพิมพ์ใหญ่เสมอ)
      - **Shopee Hint**: มักมีลูกศรย้อนกลับสีส้ม (<) อยู่มุมบนซ้าย และมีหัวข้อ "รายละเอียดคำสั่งซื้อ" อยู่ตรงกลางเลเวลเดียวกับลูกศร
      - **Lazada Hint**: มักมีโลโก้รูปหัวใจหัวเราะ หรือฟอนต์สีชมพู/น้ำเงินชัดเจน
    ...
    - receiver_name: **ชื่อผู้รับ** (บรรทัดแรกสุดใต้คำว่า "ที่อยู่ในการจัดส่ง" หรือ "ที่อยู่")
      ...
      - **พยัญชนะที่มักสับสน**: "ร/ว", "ช/ซ", "ต/ด" (เช่น **"ริชาลลล"** ต้องขึ้นต้นด้วย **"ร"** ห้ามตอบว่า **"วิชาลลล"** เด็ดขาด)
