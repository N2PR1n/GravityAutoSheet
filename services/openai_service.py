...
class OpenAIService:
    ...
    - price: **ต้องเป็น "ยอดชำระจริง" หรือ "ยอดโอน" (Net Payment / Grand Total) เท่านั้น** ให้มองหาตัวเลขที่อยู่ล่างสุด หรือท้ายสุดของบิลเสมอ (ห้ามเอาราคาต่อชิ้น Unit Price หรือยอดรวมก่อนหักส่วนลด Subtotal)
    - coins: ให้มองหาคำว่า "Shopee Coins", "เหรียญ" (ส่วนลด), "ใช้พอยท์แทนเงินสด" (Amaze) **สำหรับ Amaze: ต้องเจอคำว่า "ใช้พอยท์แทนเงินสด" เท่านั้นถึงจะเอาตัวเลขมาใส่ ถ้าไม่เจอคำนี้ให้ใส่ 0.00 ทันที (ห้ามเอาตัวเลขจาก "อเมซพอยท์ ที่จะได้รับ" มาตอบเด็ดขาด)**
