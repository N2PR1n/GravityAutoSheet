...
class OpenAIService:
    ...
    - receiver_name: **ชื่อผู้รับ** (ภาษาไทยหรืออังกฤษ) **ต้องสะกดให้ถูกต้อง 100% ห้ามเดาหรือพิมพ์ผิด ให้อ่านจากรูปภาพตามตัวอักษรเป๊ะๆ ระวังการสับสนระหว่าง "ร" กับ "ว" และ "ช" กับ "ซ" (เช่น ถ้าในรูปเขียน "ริชาลลล" ห้ามตอบ "วิซาลลล")** ให้ดูบรรทัดบนสุดของส่วนที่อยู่ ถ้ามีเบอร์โทรต่อท้ายให้ตัดเบอร์โทรออก (เช่น "ต้าร์ 093xxx" -> "ต้าร์")
    ...
    - coins: ยอดส่วนลดที่เกิดจากการใช้เหรียญหรือพอยท์แทนเงินสด (เช่น "Shopee Coins", "ใช้พอยท์แทนเงินสด")
      - ถ้าเจอคำว่า "ใช้พอยท์แทนเงินสด" **ลบ** หรือ **ส่วนลด** ให้เอาตัวเลขจำนวนเงินที่ลดมาใส่ในช่อง coins
      - **สำคัญมาก**: ถ้าไม่มีการใช้พอยท์เป็นส่วนลดให้ตอบ 0.00 ทันที
      - **ห้ามเด็ดขาด**: ห้ามเอาตัวเลขจากบรรทัด "อเมซพอยท์ ที่จะได้รับ" (Amaze Points to receive) มาตอบเด็ดขาด (เพราะนั่นคือคะแนนที่จะได้ ไม่ใช่ส่วนลดที่ใช้)
